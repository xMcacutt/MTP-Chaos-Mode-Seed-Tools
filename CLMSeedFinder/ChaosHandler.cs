...
public class ChaosHandler
{
    ...
    {
        {
            4, new PositionData[]
            {
                new PositionData(-3822.803f, 308.366f, 9116.404f),
                new PositionData(-2041.474f, 127.447f, 8776.881f),
                new PositionData(3965.84f, -720.751f, 6277.515f),
                new PositionData(-1399.128f, -746.911f, 4797.485f),
                new PositionData(-2243.23f, 281.237f, 5182.763f),
                new PositionData(-5100.461f, -230.457f, 4854.048f),
                new PositionData(2213.4f, -83.611f, 1346.88f),
                new PositionData(-202.77f, -197.27f, -1607.163f),
                new PositionData(4767.584f, -122.078f, -4117.393f),
                new PositionData(-137.779f, 413.918f, -5278.394f),
                new PositionData(2096.096f, 456.717f, -6355.519f),
                new PositionData(3671.294f, 202.835f, -6686.886f),
                new PositionData(-341.36f, -400.935f, -8601.748f),
                new PositionData(-2893.603f, 190.135f, -2475.652f),
                new PositionData(-2498.504f, 523.03f, -390.781f),
                new PositionData(1470.596f, 137.234f, -349.768f),
                new PositionData(1087.491f, 101.983f, 1053.854f),
                new PositionData(-4881.107f, 239.09f, -2702.864f),
                new PositionData(-4130.989f, -457.802f, -4515.076f),
                new PositionData(-6654.193f, 209.032f, -2406.927f),
                new PositionData(-5848.0f, 304.0f, -420.0f),
                new PositionData(4145.0f, -325.0f, -1943.0f),
                new PositionData(-1755.0f, -343.0f, 2683.0f),
                new PositionData(4432.0f, -546.0f, 5122.0f),
                new PositionData(-6126.0f, -441.0f, 3604.0f),
                new PositionData(3582.2734f, -184.97473f, 475.32822f),
                new PositionData(3085.36f, -348.62677f, -3091.4077f),
                new PositionData(-1542.7802f, 186.24399f, 958.6456f),
                new PositionData(-5122.0596f, -522.9148f, -6582.1f),
                new PositionData(-2726.5723f, -701.5983f, 1947.359f),
            }
        },
        {
            5, new PositionData[]
            {
                new PositionData(-9956.699f, -1552.092f, 6924.409f),
                new PositionData(-9207.075f, -1221.275f, 5635.146f),
                new PositionData(-7468.986f, -1405.712f, 5743.225f),
                new PositionData(-7143.794f, -1315.932f, 5645.113f),
                new PositionData(-1460.342f, -2616.124f, -4034.063f),
                new PositionData(-8533.444f, -1862.765f, -426.065f),
                new PositionData(-5676.547f, 66.905f, -95.308f),
                new PositionData(5796.938f, -3384.073f, -4376.573f),
                new PositionData(-9973.629f, -1349.276f, 3455.284f),
                new PositionData(-137.275f, -2686.874f, 1296.892f),
                new PositionData(7850.211f, -2228.991f, 1552.121f),
                new PositionData(-2025.659f, -389.882f, 9564.432f),
                new PositionData(2765.938f, -3046.89f, 200.862f),
                new PositionData(-2058.466f, -1282.954f, -7444.292f),
                new PositionData(-7793.682f, -1762.52f, 1129.029f),
                new PositionData(-8085.177f, -1457.458f, 3615.445f),
                new PositionData(-9044.725f, 1039.854f, -4817.408f),
                new PositionData(-6706.301f, 21.776f, -617.547f),
                new PositionData(-4487.0f, -294.918f, 2015.169f),
                new PositionData(-10962.784f, 762.491f, -605.935f),
                new PositionData(-10339.0f, -334.0f, -2644.0f),
                new PositionData(-2309.0f, -2031.0f, 5678.0f),
                new PositionData(-4467.0f, -1254.0f, 978.0f),
                new PositionData(562.0f, -2875.0f, 2953.0f),
                new PositionData(-10701.0f, -2510.0f, -1913.0f),
                new PositionData(-2352.6992f, -2616.124f, 1002.8282f),
                new PositionData(4612.958f, -2537.1687f, -858.83514f),
                new PositionData(1933.0237f, -167.33255f, 8245.678f),
                new PositionData(-8608.96f, 643.52893f, -1414.2255f),
                new PositionData(-6367.6978f, -770.1511f, -4481.694f),
            }
        },
        {
            6, new PositionData[]
            {
                new PositionData(-11441.138f, 275.632f, 24266.705f),
                new PositionData(-5905.033f, -12.576f, 15642.216f),
                new PositionData(-14179.623f, 2.492f, 21155.705f),
                new PositionData(-13325.058f, 275.707f, 24581.329f),
                new PositionData(7585.274f, 395.65f, 15118.996f),
                new PositionData(278.799f, 48.618f, 25929.23f),
                new PositionData(11239.742f, -16.829f, 11082.507f),
                new PositionData(6909.334f, 42.943f, 6189.175f),
                new PositionData(-14511.787f, 93.916f, 16232.41f),
                new PositionData(-12451.105f, 78.125f, -9702.298f),
                new PositionData(7358.027f, -18.527f, -18043.523f),
                new PositionData(-9191.168f, -7.318f, 17899.751f),
                new PositionData(566.244f, 5791.441f, -12336.197f),
                new PositionData(4772.742f, 35.584f, 19000.227f),
                new PositionData(6738.203f, -6.848f, 12800.188f),
                new PositionData(-18164.832f, -16.839f, 12971.375f),
                new PositionData(-9633.459f, 163.57f, 6147.973f),
                new PositionData(2919.209f, 45.588f, 19078.831f),
                new PositionData(-4319.688f, 123.159f, 11245.484f),
                new PositionData(9056.991f, 10.439f, -9417.215f),
                new PositionData(7912.0f, 86.0f, -3765.0f),
                new PositionData(2884.0f, 123.0f, -8990.0f),
                new PositionData(2772.0f, 678.0f, 21903.0f),
                new PositionData(12477.0f, 482.0f, 9308.0f),
                new PositionData(-9441.0f, 578.0f, 14725.0f),
                new PositionData(6435.7905f, 122.75342f, -4081.2888f),
                new PositionData(10779.675f, 1.2984886f, 16887.242f),
                new PositionData(6073.9565f, 1658.6746f, 18977.502f),
                new PositionData(-10781.856f, 24.918228f, 20627.84f),
                new PositionData(-9509.315f, 117.355255f, 9912.087f),
            }
        },
        {
            8, new PositionData[]
            {
                new PositionData(1383.987f, -719.713f, 5683.788f),
                new PositionData(2101.085f, -364.967f, 2447.264f),
                new PositionData(-357.118f, -338.784f, 1482.581f),
                new PositionData(-4845.4f, -115.128f, -523.695f),
                new PositionData(-2109.27f, 398.652f, -307.237f),
                new PositionData(-2172.279f, 424.576f, -2556.774f),
                new PositionData(-5877.959f, 564.352f, -3301.755f),
                new PositionData(-2488.827f, 980.332f, -3602.856f),
                new PositionData(6312.99f, 189.094f, -13622.432f),
                new PositionData(9208.809f, 124.089f, -9900.374f),
                new PositionData(12930.533f, 524.204f, -4265.194f),
                new PositionData(3206.831f, 192.365f, -1989.7f),
                new PositionData(4602.208f, 533.46f, 1140.811f),
                new PositionData(7885.76f, 610.535f, 5943.435f),
                new PositionData(-6313.873f, 1041.09f, -8252.097f),
                new PositionData(-7181.493f, 185.499f, -7254.178f),
                new PositionData(-2592.965f, 124.204f, -9611.747f),
                new PositionData(-654.343f, 106.648f, -16182.571f),
                new PositionData(9208.491f, 179.319f, -11969.719f),
                new PositionData(-3386.291f, 403.332f, 614.949f),
                new PositionData(-4300.0f, 426.0f, -2654.0f),
                new PositionData(-3479.0f, 1074.0f, -3179.0f),
                new PositionData(2531.0f, 64.0f, -6472.0f),
                new PositionData(-6273.0f, -678.0f, 4732.0f),
                new PositionData(8578.0f, 509.0f, 583.0f),
                new PositionData(10842.366f, 434.72177f, -6540.7217f),
                new PositionData(886.8873f, 53.618446f, -9577.831f),
                new PositionData(7678.854f, 778.2628f, -5073.7134f),
                new PositionData(-3762.8723f, 621.1897f, -10336.776f),
                new PositionData(-2294.308f, 129.26698f, -11711.495f),
            }
        },
        {
            9, new PositionData[]
            {
                new PositionData(-642.649f, -2603.134f, 1283.686f),
                new PositionData(5416.325f, -3255.931f, 1345.119f),
                new PositionData(14324.464f, -6367.995f, 1804.223f),
                new PositionData(16856.305f, -7779.646f, -6944.114f),
                new PositionData(2631.398f, -5541.176f, -13252.725f),
                new PositionData(34455.301f, -5868.991f, -18084.238f),
                new PositionData(-1682.196f, -3647.031f, -7422.692f),
                new PositionData(-1987.968f, -3260.601f, -5551.578f),
                new PositionData(13864.963f, -6603.062f, -6285.938f),
                new PositionData(8649.903f, -4614.118f, -4657.603f),
                new PositionData(9515.83f, -5108.783f, -7075.345f),
                new PositionData(-2468.825f, -5741.663f, -14532.724f),
                new PositionData(36931.958f, -4358.087f, -13204.597f),
                new PositionData(42646.222f, -381.637f, 3167.294f),
                new PositionData(38049.026f, -5118.895f, -6499.84f),
                new PositionData(37682.651f, -4506.253f, -19907.268f),
                new PositionData(25992.233f, -8749.711f, -9774.074f),
                new PositionData(13261.674f, -8076.424f, -18469.562f),
                new PositionData(28777.029f, -8522.737f, -5987.118f),
                new PositionData(38788.437f, -1579.344f, -1890.829f),
                new PositionData(-1287.0f, -6607.0f, -17443.0f),
                new PositionData(45445.0f, -2166.0f, -16590.0f),
                new PositionData(35324.0f, -5775.0f, -18503.0f),
                new PositionData(4928.0f, -7569.0f, -18504.0f),
                new PositionData(18544.0f, -8354.0f, -13332.0f),
                new PositionData(6330.1914f, -3981.8855f, -4343.9478f),
                new PositionData(43878.188f, -1269.1742f, -2799.5493f),
                new PositionData(41965.18f, -1717.3242f, -11173.501f),
                new PositionData(50172.906f, -3084.4375f, -19763.504f),
                new PositionData(33160.477f, -5779.2686f, 1709.2417f),
            }
        },
        {
            10, new PositionData[]
            {
                new PositionData(-17851.842f, 4654.143f, 19982.277f),
                new PositionData(-3122.043f, 3286.206f, -14639.581f),
                new PositionData(16955.121f, 3659.025f, -13137.63f),
                new PositionData(32509.851f, 4137.162f, 2948.162f),
                new PositionData(27845.593f, 4137.722f, 20061.04f),
                new PositionData(20822.916f, 4217.555f, 26977.557f),
                new PositionData(36320.233f, 3728.021f, -22167.691f),
                new PositionData(18629.466f, 3492.344f, -17837.816f),
                new PositionData(60536.932f, 5017.184f, -31992.368f),
                new PositionData(45309.665f, 10693.005f, -29898.34f),
                new PositionData(-17548.16f, 3106.025f, -5511.625f),
                new PositionData(8767.489f, 3720.652f, 8909.115f),
                new PositionData(43237.991f, 3707.748f, -15918.854f),
                new PositionData(-17284.607f, 3169.316f, -12185.963f),
                new PositionData(-10936.409f, 3600.452f, 4507.692f),
                new PositionData(-16960.716f, 4682.119f, 16904.646f),
                new PositionData(22334.399f, 4242.846f, 18712.816f),
                new PositionData(6918.679f, 3510.002f, -13025.84f),
                new PositionData(-18060.893f, 4724.723f, 18533.672f),
                new PositionData(25803.201f, 4333.992f, -447.464f),
                new PositionData(32026.0f, 4257.0f, 25326.0f),
                new PositionData(56008.0f, 3727.0f, -35631.0f),
                new PositionData(28636.0f, 4447.0f, -2721.0f),
                new PositionData(-3112.0f, 2834.0f, -9055.0f),
                new PositionData(34420.0f, 3964.0f, -14061.0f),
                new PositionData(7044.599f, 3589.6802f, -17469.66f),
                new PositionData(38928.65f, 3798.071f, -35072.223f),
                new PositionData(19302.959f, 4602.42f, 13647.788f),
                new PositionData(-11363.49f, 4791.543f, 17757.64f),
                new PositionData(39218.277f, 11860.89f, -28497.56f),
            }
        },
        {
            12, new PositionData[]
            {
                new PositionData(-4469.313f, -121.087f, 1599.222f),
                new PositionData(-3840.998f, 5.844f, 4190.916f),
                new PositionData(-8787.372f, -563.261f, 5523.847f),
                new PositionData(-7225.993f, 146.724f, 3182.057f),
                new PositionData(-10919.292f, -92.444f, 1684.453f),
                new PositionData(-10294.062f, 677.994f, -1075.797f),
                new PositionData(-8620.32f, -593.584f, -4378.58f),
                new PositionData(-1745.524f, -3022.347f, -1119.453f),
                new PositionData(-2033.949f, -3000.536f, 656.147f),
                new PositionData(-2851.515f, -2744.95f, -1113.564f),
                new PositionData(2145.716f, -2281.954f, 2134.239f),
                new PositionData(4667.796f, -2510.818f, 4081.244f),
                new PositionData(-3023.22f, -2598.258f, 7661.016f),
                new PositionData(-3158.627f, -4036.667f, 8280.918f),
                new PositionData(-6114.992f, 1058.116f, -305.027f),
                new PositionData(-7354.163f, -557.153f, 2711.841f),
                new PositionData(-5965.322f, 68.82f, 4484.624f),
                new PositionData(-4492.226f, -5.507f, 5063.18f),
                new PositionData(-6136.049f, -564.087f, 545.34f),
                new PositionData(-11465.634f, -979.018f, 7865.622f),
                new PositionData(-1716.0f, -2068.0f, 2394.0f),
                new PositionData(-4491.0f, -575.0f, 741.0f),
                new PositionData(-5630.0f, 1032.0f, -465.0f),
                new PositionData(663.0f, -2854.0f, 4703.0f),
                new PositionData(-9902.0f, -576.0f, -4261.0f),
                new PositionData(-2710.8013f, -435.34082f, -172.77069f),
                new PositionData(-10126.362f, 950.4771f, -2798.6855f),
                new PositionData(-2265.334f, -1715.6643f, 2175.7534f),
                new PositionData(-2723.2402f, -2945.3801f, -2437.9207f),
                new PositionData(-12119.986f, -539.4364f, 10085.003f),
            }
        },
        {
            13, new PositionData[]
            {
                new PositionData(-6538.992f, -501.167f, -6703.954f),
                new PositionData(2704.265f, 75.68513f, -5900.6504f),
                new PositionData(8042.02f, -470.438f, -3297.411f),
                new PositionData(2762.977f, -778.244f, -7224.633f),
                new PositionData(-3528.0f, 907.253f, -128.255f),
                new PositionData(-5374.662f, -488.438f, -1330.801f),
                new PositionData(-6883.318f, 1468.222f, 2723.359f),
                new PositionData(-498.704f, 4768.78f, 7964.632f),
                new PositionData(-537.471f, 1468.222f, 5395.647f),
                new PositionData(-13617.734f, -5651.208f, 14309.943f),
                new PositionData(-12567.678f, 983.052f, 20515.762f),
                new PositionData(8684.843f, 1468.174f, 3667.725f),
                new PositionData(-2146.814f, 6866.956f, 11677.653f),
                new PositionData(-21611.49f, -5567.132f, 22281.393f),
                new PositionData(7268.401f, 1468.239f, 6232.839f),
                new PositionData(1304.265f, -489.101f, -10153.332f),
                new PositionData(-3211.165f, -484.199f, -1979.635f),
                new PositionData(254.276f, 1468.222f, 4548.862f),
                new PositionData(-1532.589f, 1468.222f, 54.138f),
                new PositionData(9373.522f, -442.7f, -6659.131f),
                new PositionData(-817.0f, 823.0f, -1794.0f),
                new PositionData(1278.0f, -437.0f, -5337.0f),
                new PositionData(5210.0f, -6.0f, -9636.0f),
                new PositionData(-3272.0f, -487.0f, 442.0f),
                new PositionData(3922.0f, 1494.0f, -1607.0f),
                new PositionData(-24014.725f, -5592.5366f, 21348.113f),
                new PositionData(2425.176f, -193.70284f, -8776.701f),
                new PositionData(2528.2407f, -325.11023f, -2546.0088f),
                new PositionData(-4671.6016f, -488.2593f, -1559.3779f),
                new PositionData(-7779.245f, 10568.726f, 18036.385f),
            }
        },
        {
            14, new PositionData[]
            {
                new PositionData(-15110.902f, -1438.521f, 1225.359f),
                new PositionData(-14481.358f, -1427.812f, 4200.94f),
                new PositionData(12808.463f, -1497.171f, 9602.831f),
                new PositionData(11446.785f, -1540.213f, -5483.665f),
                new PositionData(21538.525f, -1490.331f, -20191.469f),
                new PositionData(27761.603f, -1458.593f, -3934.944f),
                new PositionData(26710.031f, -1261.807f, -2464.766f),
                new PositionData(20687.856f, -1563.734f, 15831.236f),
                new PositionData(14640.469f, -1507.541f, 4287.658f),
                new PositionData(24080.62f, -1596.778f, -9235.065f),
                new PositionData(23568.62f, -1499.25f, -24453.403f),
                new PositionData(13935.051f, -1505.314f, -24422.328f),
                new PositionData(30705.966f, -1465.768f, -31200.278f),
                new PositionData(34034.79f, -1205.902f, -31462.354f),
                new PositionData(26739.676f, -1482.959f, -4756.506f),
                new PositionData(22233.293f, -1486.274f, -439.099f),
                new PositionData(21825.662f, -1553.873f, 5981.611f),
                new PositionData(5862.78f, -1331.382f, -20210.175f),
                new PositionData(-14395.734f, -1736.885f, -12159.346f),
                new PositionData(904.537f, -1496.854f, -10005.908f),
                new PositionData(20476.0f, -1192.0f, -9637.0f),
                new PositionData(11742.0f, -1499.0f, -19244.0f),
                new PositionData(-10974.0f, -719.0f, -7756.0f),
                new PositionData(11755.0f, -1496.0f, -3477.0f),
                new PositionData(23990.0f, -1505.0f, 16246.0f),
                new PositionData(-12543.87f, -1633.0807f, -1534.6542f),
                new PositionData(31797.518f, -1460.7288f, -2692.8457f),
                new PositionData(19131.611f, -1204.5575f, -34428.61f),
                new PositionData(24078.885f, -1496.308f, -4124.016f),
                new PositionData(26129.506f, -1724.111f, -17254.016f),
            }
        }
    };
    
    private Dictionary<int, PositionData[]> _movingCogPositions = new()
    {
        {
            4, new PositionData[]
            {
                new PositionData(-3740f, 351f, 7912f),
            }
        },
        {
            5, new PositionData[]
            {
                new PositionData(183f, -2950f, -1000f),
            }
        },
        {
            6, new PositionData[]
            {
                    new PositionData(1105f, 1994f, -10050f),
            }
        },
        {
            8, new PositionData[]{ }
    ...
    public readonly int[] MainStages = new[] { 4, 5, 6, 8, 9, 10, 12, 13, 14 };
    ...
    public void ShuffleIndices(int seed)
    {
        ...
        foreach (var level in MainStages)
        {
            // Generate 10 random cog indices
            var cogs = new HashSet<byte>();
            while (cogs.Count < 10)
                cogs.Add((byte)_random.Next(0, 55 + _movingCogPositions[level].Length));
            ...
            CurrentPositionIndices.Add(level, randomisedCollectibleIndices);
        }
    } 
    
    public PositionData[] GetPositions(int level, byte[] levelIndices)
    {
        var positionData = new PositionData[15];
        // Cache frequently accessed arrays in local variables
        var staticCogPositionsLevel = _staticCogPositions[level];
        var movingCogPositionsLevel = _movingCogPositions[level];
        var staticBilbyPositionsLevel = _staticBilbyPositions[level];
        for (var cogIdx = 0; cogIdx < 10; cogIdx++)
        {
            int index = levelIndices[cogIdx];
            if (index >= 55)
                positionData[cogIdx] = movingCogPositionsLevel[index - 55];
            else
                positionData[cogIdx] = staticCogPositionsLevel[index];
        }
        for (var bilbyIdx = 10; bilbyIdx < 15; bilbyIdx++)
            positionData[bilbyIdx] = staticBilbyPositionsLevel[levelIndices[bilbyIdx]];
        return positionData;
    }
}